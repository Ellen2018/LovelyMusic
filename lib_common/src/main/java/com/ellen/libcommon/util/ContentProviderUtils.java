...
import com.ellen.libcommon.util.collectionutil.ArrangeInterface;
...
public class ContentProviderUtils {
    ...
    public List<String> getIamgePathList(Context context) {
    ...
    public List<String> getVideoPathList(Context context) {
    ...
    public List<Music> getMusicPathList(Context context) {
